    ...
    <form method="post"  action="sua_loai_san_pham">
        <fieldset>
            ...
            <p>
              ...
              <input class="text-input small-input kiemtra" readonly type="text" id="ten_loai_san_pham" name="ma_loai" value="<%= lsp.getMa_loai() %>" />
          </p>
          
          <p>
              <label class="alert">Tên loai</label>
              <input class="text-input small-input kiemtra" type="text" id="ten_loai_san_pham" name="ten_loai" value="<%= lsp.getTen_loai() %>" />
          </p>
